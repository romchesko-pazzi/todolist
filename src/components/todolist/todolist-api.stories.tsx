...
export const CreateTodolist = () => {
  ...
  const createTodolist = () => {
    if (title !== '') {
      todolistsAPI.createTodolist(title).catch(console.log);
    }
    setTodolistTitle('');
  };
...
export const DeleteTodolist = () => {
  ...
  const deleteTodolist = () => {
    if (todolistId !== '') {
      todolistsAPI.deleteTodolist(todolistId).catch(console.log);
    }
    settodolistId('');
  };
...
export const UpdateTodolistTitle = () => {
  ...
  const updateTodolistTitle = () => {
    if (title !== '') {
      todolistsAPI.updateTodolist(todolistId, title).catch(console.log);
    }
    setTodolistTitle('');
  };
  ...
  return (
    <div>
      ...
      <div>
        <button type="button" onClick={updateTodolistTitle}>
